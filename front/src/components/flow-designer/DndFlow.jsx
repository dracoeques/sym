...
import numericDecisionNode from './numericDecisionNode';
import parseNode from './parseNode';
import personalizeNode from './personalizeNode';
...
const nodeTypes = {
    ...
    prompt: promptNode,
    storage: storageNode,
    question: textInputNode,
    finish: finishNode,
    loop: continueNode,
    binary_numeric_decision: numericDecisionNode,
    parse: parseNode,
      ...
      <DndSidebar />
        <div className="reactflow-wrapper" ref={reactFlowWrapper}>
          <ReactFlow
            ...
            nodeTypes={nodeTypes}
            //fitView
            onClick={()=>{console.log("click background")}}
